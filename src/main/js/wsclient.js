...
var probe_acc_z=0;
    ...
    function onConnectClick() {
        ...
        openWSConnection("ws", ws_hostname, ws_port, "");
    }
    /**
        ...
        try {
            ...
            webSocket.onmessage = function (messageEvent) {
                ...
                if (wsMsg.indexOf("error") > 0) {
                    ...
                    if(wsMsg.startsWith("15")){
                        let x=1,y=0,z=0;
                        let lastsemicol =wsMsg.lastIndexOf(";");
                        if(lastsemicol >0){
                            let vals = wsMsg.substring(lastsemicol+1).split(",");
                            renderProbe(vals[0],vals[1],vals[2],vals[3],vals[4],vals[5]);
                        }
                    } else {
